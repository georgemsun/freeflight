...
function torque_calculator() {
	...
	//a = C*T*L/G*D^4
	if(torque == "" && length > 0 && diameter > 0 && angle > 0) {
	...
	else if(torque > 0 && length == "" && diameter > 0 && angle > 0) {
	...
	else if(torque > 0 && length > 0 && diameter == "" && angle > 0) {
	...
	else if(torque > 0 && length > 0 && diameter > 0 && angle == "") {
	...
	else if(torque > 0 && length > 0 && diameter > 0 && angle > 0) {
...
setInterval(torque_calculator, 10);