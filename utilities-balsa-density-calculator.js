...
function balsa_density_calculator() {
	...
	if(thickness > 0 && width > 0 && length > 0 && density_select != "") {
		...
		else if($('#balsa-density-calculator #density-enter').val() != "")		$('#balsa-density-calculator #output').html("Mass: " + ($('#balsa-density-calculator #density-enter').val()*(thickness * width * length / 1728)/0.00220462).toFixed(3) + " grams (" + ($('#balsa-density-calculator #density-enter').val()*(thickness * width * length / 1728)).toFixed(3) + " pounds)");
		else $('#balsa-density-calculator #output').html("");
	}
